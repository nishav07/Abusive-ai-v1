...
now here is user prompt (${userPrompt}) try to reply shorter in token saving mode `;
...
now here is user prompt (${userPrompt}) and try to reply shorter in token saving mode `;
